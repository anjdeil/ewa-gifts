    ...
    return (
        <div>
            ...
            <div id={nextElId} className={`swiper-button-next ${styles.sliderMenu__navBtn}`}>
                <svg width="13" height="7" viewBox="0 0 13 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.49979 0.5C1.30204 0.500035 1.10874 0.548928 0.944329 0.640498C0.779919 0.732069 0.651779 0.862205 0.576109 1.01445C0.500439 1.1667 0.480636 1.33423 0.519203 1.49586C0.557771 1.65749 0.652978 1.80596 0.792787 1.9225L5.79279 6.08917C5.98031 6.24539 6.23462 6.33316 6.49979 6.33316C6.76495 6.33316 7.01926 6.24539 7.20679 6.08917L12.2068 1.9225C12.3466 1.80596 12.4418 1.65749 12.4804 1.49586C12.5189 1.33423 12.4991 1.1667 12.4235 1.01445C12.3478 0.862205 12.2197 0.732069 12.0552 0.640498C11.8908 0.548928 11.6975 0.500035 11.4998 0.5L1.49979 0.5Z" fill="#696969" />
                </svg>
            </div>
        </div>
