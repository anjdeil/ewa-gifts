...
const SwiperPopup = ({onClose}) => {
    const handlerClickBg = ({target}) => {
        if (target.classList.contains(styles.swiper_popup)) {
            onClose();
        }
    }
    const handlerClick = () => {
    ...
    return (
        <div className={styles.swiper_popup} onClick={handlerClickBg}>
            <div className={styles.swiper_popup__body}>
                <IconButton className={styles.swiper_popup__close} onClick={handlerClick}>
