                ...
                <li className={styles["mini-cart__item"]}>
                    <div className={styles["mini-cart__item-image-wrap"]}>
                        <Image
                            ...
                            src={'https://new.ewagifts.pl/wp-content/uploads/2024/05/large-worek-bawelniany-002402.jpg'}
                        />
                    </div>
                    <div className={styles["mini-cart__item-info"]}>
                        <p className={styles["mini-cart__item-name"]}>
                            Czapka z daszkiem 6-panelowa SAN FRANCISCO
                        </p>
                        <div className="cart-item-quty">
                            <span className="cart-item-quty__quty">1</span>
                            ...
                            <span className="cart-item-quty__price">4.34 zł.</span>
                        </div>
                    </div>
